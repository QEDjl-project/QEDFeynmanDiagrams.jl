...
Furthermore, it can generate code to compute the matrix element for scattering processes, using [ComputableDAGs.jl](https://github.com/ComputableDAGs/ComputableDAGs.jl).
