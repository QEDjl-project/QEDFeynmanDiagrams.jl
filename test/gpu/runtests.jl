...
if oneapi_tests
    try
        ...
        GPU_TYPES_CDAG[oneAPI] = Nothing # TODO: add proper type when CDAGs.jl has support
...
if metal_tests
    try
        ...
        GPU_TYPES_CDAG[Metal] = Nothing # TODO: add proper type when CDAGs.jl has support
